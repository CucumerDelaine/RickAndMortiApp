...
import com.example.feature_details_impl.di.module.NavigationModule
...
@Component(
    ...
    dependencies = [CoreDbApi::class, CoreAppApi::class, CharListApi::class]
)
@DetailsScope
...
@DetailsScope
interface DetailsNavComponent : DetailsApi